...
let InsightsService = class InsightsService {
    constructor(insightsByPeriodRepository, compactionService, collectionService, license, logger) {
    ...
    getAvailableDateRanges() {
        const maxHistoryInDays = this.license.getInsightsMaxHistory() === -1
        ...
        return api_types_1.INSIGHTS_DATE_RANGE_KEYS.map((key) => ({
            key,
            licensed: key === 'day' ? (isHourlyDateEnabled ?? false) : maxHistoryInDays >= keyRangeToDays[key],
