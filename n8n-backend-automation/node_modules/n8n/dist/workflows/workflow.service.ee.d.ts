...
export declare class EnterpriseWorkflowService {
    ...
    transferOne(user: User, workflowId: string, destinationProjectId: string, shareCredentials?: string[], destinationParentFolderId?: string): Promise<{
        error: {
            message: string;
