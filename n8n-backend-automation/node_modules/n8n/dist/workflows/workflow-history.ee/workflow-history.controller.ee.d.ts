...
export declare class WorkflowHistoryController {
    ...
    getList(req: WorkflowHistoryRequest.GetList, _res: Response, query: PaginationDto): Promise<Omit<import("../../databases/entities/workflow-history").WorkflowHistory, "nodes" | "connections">[]>;
