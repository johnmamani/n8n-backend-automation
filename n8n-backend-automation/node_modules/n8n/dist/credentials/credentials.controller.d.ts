...
export declare class CredentialsController {
    ...
    getMany(req: CredentialRequest.GetMany, _res: unknown, query: CredentialsGetManyRequestQuery): Promise<import("../databases/entities/credentials-entity").CredentialsEntity[]>;
